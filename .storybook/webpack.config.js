...
const shouldIncludeAllSupportedBrowsers = process.env.NODE_ENV === 'production' || process.env.BROWSERSLIST_ENV === 'production';
...
module.exports = async ({ config }) => {
    ...
    config.resolve.alias = {
        ...
        'box-locale-data': path.resolve(`node_modules/@box/cldr-data/es/locale-data/${language}`),
    };
