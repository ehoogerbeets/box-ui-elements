/**
 * Auto-generated Locale Data File for es-ES.
...
const numbers: NumbersData = {
    long: [
        ...
        {
            digits: 1,
            msg: '{count, plural, other {# millones} one {# millón}}',
        },
        {
            digits: 2,
            msg: '{count, number} millones',
        },
        {
            digits: 3,
            msg: '{count, number} millones',
        ...
        {
            digits: 1,
            msg: '{count, plural, other {# billones} one {# billón}}',
        },
        {
            digits: 2,
            msg: '{count, number} billones',
        },
    ],
    short: [
        {
